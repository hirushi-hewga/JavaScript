...
//let numA = +prompt("Enter your number A :")
//let numB = +prompt("Enter your number B :")
//let _1 = function(a,b){return `${a} + ${b} = ${a+b}`}
//let _2 = function(a,b){return `${a} - ${b} = ${a-b}`}
//let _3 = function(a,b){return `${a} * ${b} = ${a*b}`}
//let _4 = function(a,b){return `${a} / ${b} = ${a/b}`}
//alert(_1(numA,numB)+'\n'+_2(numA,numB)+'\n'+_3(numA,numB)+'\n'+_4(numA,numB))
...
//let numA = +prompt("Enter your number A :")
//let numB = +prompt("Enter your number B :")
//let func = function(a,b){return `${a} * x + ${b} = 0\nx = ${(-b)/a}`}
